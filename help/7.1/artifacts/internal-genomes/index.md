...
An internal genome is any <span class="artifact-n">[bin](/help/7.1/artifacts/bin)</span> described in an anvi'o <span class="artifact-n">[collection](/help/7.1/artifacts/collection)</span> stored in an anvi'o <span class="artifact-n">[profile-db](/help/7.1/artifacts/profile-db)</span>. You can obtain one of these by binning a metagenome assembly (stored in an anvi'o <span class="artifact-n">[contigs-db](/help/7.1/artifacts/contigs-db)</span>), which you can do either manually in the interactive interface or automatically with a binning software, and saving or importing it into a <span class="artifact-n">[collection](/help/7.1/artifacts/collection)</span>.

The internal genomes file format enables anvi'o to work with one or more bins from one or more collections that may be defined in different anvi'o <span class="artifact-n">[profile-db](/help/7.1/artifacts/profile-db)</span> files. A TAB-delimited internal genomes file will be composed of at least the following five columns:
...
Also see **<span class="artifact-n">[external-genomes](/help/7.1/artifacts/external-genomes)</span>** and **<span class="artifact-n">[metagenomes](/help/7.1/artifacts/metagenomes)</span>**.
