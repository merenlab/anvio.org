...
As an artifact, this describes the variability information about a single sample calculated when you ran <span class="artifact-n">[anvi-profile](/help/7.1/programs/anvi-profile)</span>. To examine variability across samples, you'll want to use this information (which is stored within your <span class="artifact-n">[profile-db](/help/7.1/artifacts/profile-db)</span>) to run <span class="artifact-n">[anvi-gen-variability-profile](/help/7.1/programs/anvi-gen-variability-profile)</span>. 
...
There are two types of variability the program <span class="artifact-n">[anvi-profile](/help/7.1/programs/anvi-profile)</span> can characterize and store: substitutions and indels.
...
You can learn the name of the table in which anvi'o stores this in a given <span class="artifact-n">[profile-db](/help/7.1/artifacts/profile-db)</span> by running this command in your anvi'o environment:
