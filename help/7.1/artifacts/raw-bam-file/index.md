...
This is a **<span class="artifact-n">[bam-file](/help/7.1/artifacts/bam-file)</span> (which contains aligned sequence data) that has not yet been indexed and sorted**. 
...
You can either do this directly using samtools, or you can just run the anvi'o program <span class="artifact-n">[anvi-init-bam](/help/7.1/programs/anvi-init-bam)</span> (which uses samtools for you). 
