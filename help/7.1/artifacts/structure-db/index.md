...
This database contains the protein structural data for genes in a corresponding <span class="artifact-n">[contigs-db](/help/7.1/artifacts/contigs-db)</span> and can be generated with <span class="artifact-n">[anvi-gen-structure-database](/help/7.1/programs/anvi-gen-structure-database)</span>.


Currently, this database is best utilized for visualizing 3D structures with <span class="artifact-n">[anvi-display-structure](/help/7.1/programs/anvi-display-structure)</span>.  
