...
A helper script to process CheckM tree output to generate files compatible with <span class="artifact-n">[anvi-interactive](/help/7.1/programs/anvi-interactive)</span>.
