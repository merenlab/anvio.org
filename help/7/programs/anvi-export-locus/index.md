...
This program lets you export selections of your <span class="artifact-n">[contigs-db](/help/7/artifacts/contigs-db)</span> around all occurances of a user-defined anchor gene. 
