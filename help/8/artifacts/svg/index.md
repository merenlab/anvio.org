...
As of now, <span class="artifact-p">[anvi-display-contigs-stats](/help/8/programs/anvi-display-contigs-stats)</span>, <span class="artifact-p">[anvi-display-pan](/help/8/programs/anvi-display-pan)</span>, and <span class="artifact-p">[anvi-interactive](/help/8/programs/anvi-interactive)</span> will give you an svg output every time you click the little save button at the bottom-left corner of the settings panel in the interface. You can even customize the location of that output using the flag `--export-svg`. 
