...
You can convert the information in a <span class="artifact-n">[variability-profile-txt](/help/8/artifacts/variability-profile-txt)</span> to <span class="artifact-n">[vcf](/help/8/artifacts/vcf)</span> with the program <span class="artifact-p">[anvi-script-variability-to-vcf](/help/8/programs/anvi-script-variability-to-vcf)</span>. 
