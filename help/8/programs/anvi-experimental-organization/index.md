...
This program can use an anvi'o <span class="artifact-n">[clustering-configuration](/help/8/artifacts/clustering-configuration)</span> file to access various data sources in anvi'o databases to produce a hierarchical clustering dendrogram for items.
