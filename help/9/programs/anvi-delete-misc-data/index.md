...
categories: [anvio]
comments: false
redirect_from: /9/anvi-delete-misc-data
image:
...
After you've added misc-data of some kind (<span class="artifact-n">[misc-data-items](/help/9/artifacts/misc-data-items)</span>, <span class="artifact-n">[misc-data-layers](/help/9/artifacts/misc-data-layers)</span>, <span class="artifact-n">[misc-data-layer-orders](/help/9/artifacts/misc-data-layer-orders)</span>, <span class="artifact-n">[misc-data-nucleotides](/help/9/artifacts/misc-data-nucleotides)</span>, or <span class="artifact-n">[misc-data-amino-acids](/help/9/artifacts/misc-data-amino-acids)</span>) using <span class="artifact-p">[anvi-import-misc-data](/help/9/programs/anvi-import-misc-data)</span>, you can **delete that data and remove it from the interactive interface** using this program. 

This program will release your data into the ether, never to be seen again. If you would like to first export it into a text file (so that it can be seen again), you can do so with <span class="artifact-p">[anvi-export-misc-data](/help/9/programs/anvi-export-misc-data)</span>. 
...
anvi&#45;delete&#45;misc&#45;data &#45;p <span class="artifact&#45;n">[profile&#45;db](/help/9/artifacts/profile&#45;db)</span> \
...
<div class="codeblock" markdown="1">
anvi&#45;delete&#45;misc&#45;data &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/9/artifacts/contigs&#45;db)</span> \
...
**From a <span class="artifact-n">[pan-db](/help/9/artifacts/pan-db)</span> or <span class="artifact-n">[profile-db](/help/9/artifacts/profile-db)</span>, you can delete**

- items data (<span class="artifact-n">[misc-data-items](/help/9/artifacts/misc-data-items)</span>) 
...
- layers data (<span class="artifact-n">[misc-data-layers](/help/9/artifacts/misc-data-layers)</span>)

<div class="codeblock" markdown="1">
anvi&#45;delete&#45;misc&#45;data &#45;p <span class="artifact&#45;n">[pan&#45;db](/help/9/artifacts/pan&#45;db)</span> \
                      &#45;&#45;target&#45;data&#45;table layers \
                      &#45;&#45;keys&#45;to&#45;remove key_2,key_3
</div>

- layer orders data (<span class="artifact-n">[misc-data-layer-orders](/help/9/artifacts/misc-data-layer-orders)</span>)
...
**From a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>, you can delete**

- nucleotide data (<span class="artifact-n">[misc-data-nucleotides](/help/9/artifacts/misc-data-nucleotides)</span>)
...
- amino acid data (<span class="artifact-n">[misc-data-amino-acids](/help/9/artifacts/misc-data-amino-acids)</span>)
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/delete_misc_data.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
