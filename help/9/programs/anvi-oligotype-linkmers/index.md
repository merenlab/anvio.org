...
categories: [anvio]
comments: false
redirect_from: /9/anvi-oligotype-linkmers
image:
...
This program converts a <span class="artifact-n">[linkmers-txt](/help/9/artifacts/linkmers-txt)</span> artifact into <span class="artifact-n">[oligotypes](/help/9/artifacts/oligotypes)</span> data.

A <span class="artifact-n">[linkmers-txt](/help/9/artifacts/linkmers-txt)</span> artifact describes each of your short reads that mapped to specific target nucleotide positions in a reference contig. This program counts the total occurance of each combination in those target positions within each of your samples. 

For example, if your <span class="artifact-n">[linkmers-txt](/help/9/artifacts/linkmers-txt)</span> focused on two target positions, and you ran the following:

<div class="codeblock" markdown="1">
anvi&#45;oligotype&#45;linkmers &#45;i <span class="artifact&#45;n">[linkmers&#45;txt](/help/9/artifacts/linkmers&#45;txt)</span> 
</div>
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/oligotype_linkmers.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
