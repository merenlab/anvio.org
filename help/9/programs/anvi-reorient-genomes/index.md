...
categories: [anvio]
comments: false
redirect_from: /9/anvi-reorient-genomes
image:
...
<span class="artifact&#45;p">[anvi&#45;reorient&#45;genomes](/help/9/programs/anvi&#45;reorient&#45;genomes)</span> &#45;&#45;fasta&#45;txt <span class="artifact&#45;n">[fasta&#45;txt](/help/9/artifacts/fasta&#45;txt)</span> \
...
<div class="codeblock" markdown="1">
anvi&#45;reorient&#45;genomes &#45;&#45;fasta&#45;txt <span class="artifact&#45;n">[fasta&#45;txt](/help/9/artifacts/fasta&#45;txt)</span> \
...
1. **Parse inputs and pick a reference**. Reads <span class="artifact-n">[fasta-txt](/help/9/artifacts/fasta-txt)</span>, and if `--reference` is not set, the program picks the genome with the fewest contigs (ties broken by longest total length). All FASTAs are sanity-checked (existence, FASTA format). The reference must be a single-contig circular genome.
...
7. **Write outputs**. Copies the reference <span class="artifact-n">[fasta](/help/9/artifacts/fasta)</span> to the output directory (potentially rotated if auto-selected). Writes each reoriented query <span class="artifact-n">[fasta](/help/9/artifacts/fasta)</span> under the same name (and using the original extension).
