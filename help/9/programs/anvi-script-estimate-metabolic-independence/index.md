...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-estimate-metabolic-independence
image:
...
This script will use by default the list of modules that we determined to be associated with high metabolic independence, and calculate the completion scores of these modules in a given <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> to classify it as an HMI or an LMI organism. Here is an example run:

<div class="codeblock" markdown="1">
anvi&#45;script&#45;estimate&#45;metabolic&#45;independence &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/9/artifacts/contigs&#45;db)</span>
</div>
...
anvi&#45;script&#45;estimate&#45;metabolic&#45;independence &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/9/artifacts/contigs&#45;db)</span> \
                                            ...
                                            &#45;&#45;threshold 20 \
                                            &#45;&#45;kegg&#45;data&#45;dir <span class="artifact&#45;n">[kegg&#45;data](/help/9/artifacts/kegg&#45;data)</span> \
</div>
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/estimate_metabolic_independence.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
