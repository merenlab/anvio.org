...
categories: [anvio]
comments: false
redirect_from: /9/anvi-gen-variability-network
image:
...
This program takes in a <span class="artifact-n">[variability-profile-txt](/help/9/artifacts/variability-profile-txt)</span> file reported by the program <span class="artifact-p">[anvi-gen-variability-profile](/help/9/programs/anvi-gen-variability-profile)</span>, and generates a simple representation of this complex data so it can be visualized as a network.
...
anvi&#45;gen&#45;variability&#45;network &#45;i <span class="artifact&#45;n">[variability&#45;profile&#45;txt](/help/9/artifacts/variability&#45;profile&#45;txt)</span> \
...
Reporting the data as a matrix enables quick visualization opportunities using the programs <span class="artifact-p">[anvi-matrix-to-newick](/help/9/programs/anvi-matrix-to-newick)</span> and <span class="artifact-p">[anvi-interactive](/help/9/programs/anvi-interactive)</span>:
