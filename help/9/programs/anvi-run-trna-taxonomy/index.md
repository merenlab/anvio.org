...
categories: [anvio]
comments: false
redirect_from: /9/anvi-run-trna-taxonomy
image:
...
This program associates the tRNA reads found in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> with taxonomy information. 

Once these associations are stored in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> (represented by a <span class="artifact-n">[trna-taxonomy](/help/9/artifacts/trna-taxonomy)</span> artifact), you'll be able to run <span class="artifact-p">[anvi-estimate-trna-taxonomy](/help/9/programs/anvi-estimate-trna-taxonomy)</span> to use the associations to estimate taxonomy on a larger scale (i.e. for a genome or metagenome). 

To run this program, you'll need to have set up two things: 
1. a <span class="artifact-n">[trna-taxonomy-db](/help/9/artifacts/trna-taxonomy-db)</span>, which you can set up by running <span class="artifact-p">[anvi-setup-trna-taxonomy](/help/9/programs/anvi-setup-trna-taxonomy)</span>.
2. the 'transfer-RNAs' HMM hits in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>, which you can set up by running <span class="artifact-p">[anvi-scan-trnas](/help/9/programs/anvi-scan-trnas)</span>
...
anvi&#45;run&#45;trna&#45;taxonomy &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/9/artifacts/contigs&#45;db)</span>
</div>
...
When changing these parameters, it might be a good idea to run <span class="artifact-p">[anvi-estimate-trna-taxonomy](/help/9/programs/anvi-estimate-trna-taxonomy)</span> with the `--debug` flag so that you can see what your results look like under the hood. 
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/run_trna_taxonomy.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
