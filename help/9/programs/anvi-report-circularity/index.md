...
categories: [anvio]
comments: false
redirect_from: /9/anvi-report-circularity
image:
...
This program takes advantage of paired-end read technology and uses reverse-forward (`RF`) read pairs to determine whether a given contig in a given <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> is circular, linear, or indeterminate by making use of the insert size distributions in the entirety of the <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span>.

The default command-line usage is simple:

<div class="codeblock" markdown="1">
<span class="artifact&#45;p">[anvi&#45;report&#45;circularity](/help/9/programs/anvi&#45;report&#45;circularity)</span> <span class="artifact&#45;n">[bam&#45;file](/help/9/artifacts/bam&#45;file)</span> \
                            &#45;o <span class="artifact&#45;n">[contig&#45;circularity&#45;report&#45;txt](/help/9/artifacts/contig&#45;circularity&#45;report&#45;txt)</span>
</div>
...
{:.notice}
You can always see a histogram of insert sizes in your <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> using <span class="artifact-p">[anvi-get-tlen-dist-from-bam](/help/9/programs/anvi-get-tlen-dist-from-bam)</span> and figure out how well you did.
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/report_circularity.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
