...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-variability-to-vcf
image:
...
This script **converts a <span class="artifact-n">[variability-profile-txt](/help/9/artifacts/variability-profile-txt)</span> into <span class="artifact-n">[vcf](/help/9/artifacts/vcf)</span> (Variant Call Format).** 

It is very easy to run: just provide the input and output paths as so:

<div class="codeblock" markdown="1">
anvi&#45;script&#45;variability&#45;to&#45;vcf &#45;i <span class="artifact&#45;n">[variability&#45;profile&#45;txt](/help/9/artifacts/variability&#45;profile&#45;txt)</span> \ 
                               &#45;o <span class="artifact&#45;n">[vcf](/help/9/artifacts/vcf)</span> 
</div>

Note that to run this, you'll need to have run <span class="artifact-p">[anvi-gen-variability-profile](/help/9/programs/anvi-gen-variability-profile)</span> with the default nucleotide engine. 
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/variability_to_vcf.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
