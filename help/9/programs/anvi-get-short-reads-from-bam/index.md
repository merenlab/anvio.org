...
categories: [anvio]
comments: false
redirect_from: /9/anvi-get-short-reads-from-bam
image:
...
Get short reads from a <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> in the form of <span class="artifact-n">[short-reads-fasta](/help/9/artifacts/short-reads-fasta)</span>).
...
* Get reads matching to contig names found in any <span class="artifact-n">[bin](/help/9/artifacts/bin)</span> in a <span class="artifact-n">[collection](/help/9/artifacts/collection)</span>
* Get reads matching to contig names found in one or more specific <span class="artifact-n">[bin](/help/9/artifacts/bin)</span>s in a <span class="artifact-n">[collection](/help/9/artifacts/collection)</span>
...
You can choose to only return the short reads that are contained within a <span class="artifact-n">[collection](/help/9/artifacts/collection)</span>:
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/get_short_reads_from_bam.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
