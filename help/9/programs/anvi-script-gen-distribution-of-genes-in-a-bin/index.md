...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-gen-distribution-of-genes-in-a-bin
image:
...
This program computes the detection of genes (inputted as a <span class="artifact-n">[bin](/help/9/artifacts/bin)</span>) across your samples, so that you can visualize them in the <span class="artifact-n">[interactive](/help/9/artifacts/interactive)</span> interface. 
...
Essentially, you provide a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> and <span class="artifact-n">[profile-db](/help/9/artifacts/profile-db)</span> pair, as well as the <span class="artifact-n">[bin](/help/9/artifacts/bin)</span> you want to look at, and this program will  search each gene in your bin against the samples denoted in your <span class="artifact-n">[profile-db](/help/9/artifacts/profile-db)</span>: 

<div class="codeblock" markdown="1">
anvi&#45;script&#45;gen&#45;distribution&#45;of&#45;genes&#45;in&#45;a&#45;bin &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/9/artifacts/contigs&#45;db)</span> \ 
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/gen_distribution_of_genes_in_a_bin.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
