...
categories: [anvio]
comments: false
redirect_from: /9/anvi-setup-pfams
image:
...
This program **downloads and organizes a local copy of the data from EBI's [Pfam database](https://pfam.xfam.org/) for use in function annotation.** This program generates a <span class="artifact-n">[pfams-data](/help/9/artifacts/pfams-data)</span> artifact, which is required to run the program <span class="artifact-p">[anvi-run-pfams](/help/9/programs/anvi-run-pfams)</span>. 
...
If you already have a <span class="artifact-n">[pfams-data](/help/9/artifacts/pfams-data)</span> artifact and are trying to redownload this data, run 
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/setup_pfams.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
