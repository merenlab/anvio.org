...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-gen-hmm-hits-matrix-across-genomes
image:
...
This program lets you look at the <span class="artifact-n">[hmm-hits](/help/9/artifacts/hmm-hits)</span> from a single <span class="artifact-n">[hmm-source](/help/9/artifacts/hmm-source)</span> across multiple genomes or bins, by creating a <span class="artifact-n">[hmm-hits-across-genomes-txt](/help/9/artifacts/hmm-hits-across-genomes-txt)</span>.

{:.notice}
For a simlar program that reports function hits across genomes, see <span class="artifact-p">[anvi-script-gen-function-matrix-across-genomes](/help/9/programs/anvi-script-gen-function-matrix-across-genomes)</span>.

The input of this program can be either an <span class="artifact-n">[internal-genomes](/help/9/artifacts/internal-genomes)</span> or an <span class="artifact-n">[external-genomes](/help/9/artifacts/external-genomes)</span>.

Here are two example run on an internal-genomes:

<div class="codeblock" markdown="1">
anvi&#45;script&#45;gen&#45;hmm&#45;hits&#45;matrix&#45;across&#45;genomes &#45;i <span class="artifact&#45;n">[internal&#45;genomes](/help/9/artifacts/internal&#45;genomes)</span> \
                                               &#45;&#45;hmm&#45;source Bacteria_71 \
                                               &#45;o output.txt
</div>

To list the <span class="artifact-n">[hmm-source](/help/9/artifacts/hmm-source)</span>s common to the datasets that you're analyzing, just add the flag `--list-hmm-sources`, as so:

<div class="codeblock" markdown="1">
anvi&#45;script&#45;gen&#45;hmm&#45;hits&#45;matrix&#45;across&#45;genomes &#45;e <span class="artifact&#45;n">[external&#45;genomes](/help/9/artifacts/external&#45;genomes)</span> \
                                               &#45;&#45;list&#45;hmm&#45;sources
</div>
