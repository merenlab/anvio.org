...
categories: [anvio]
comments: false
redirect_from: /9/anvi-setup-ncbi-cogs
image:
...
This program **downloads and organizes a local copy of the data from NCBI's [COGs database](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC102395/) for use in function annotation.** This program generates a <span class="artifact-n">[cogs-data](/help/9/artifacts/cogs-data)</span> artifact, which is required to run the program <span class="artifact-p">[anvi-run-ncbi-cogs](/help/9/programs/anvi-run-ncbi-cogs)</span>.
...
If you already have a <span class="artifact-n">[cogs-data](/help/9/artifacts/cogs-data)</span> artifact and are trying to redownload this data, run
...
Not sure which versions of <span class="artifact-n">[cogs-data](/help/9/artifacts/cogs-data)</span> are available? You can type something random after the `--cog-version` parameter to see the options.
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/setup_ncbi_cogs.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
