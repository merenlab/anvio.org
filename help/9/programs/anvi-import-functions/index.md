...
categories: [anvio]
comments: false
redirect_from: /9/anvi-import-functions
image:
...
This program **takes in a <span class="artifact-n">[functions-txt](/help/9/artifacts/functions-txt)</span> to annotate your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> with <span class="artifact-n">[functions](/help/9/artifacts/functions)</span>.** Basically, if you have already have the gene functions for the contigs in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> available in a file, you can import them into anvi'o using this command. 
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/import_functions.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
