...
categories: [anvio]
comments: false
redirect_from: /9/anvi-display-metabolism
image:
...
The purpose of <span class="artifact-p">[anvi-display-metabolism](/help/9/programs/anvi-display-metabolism)</span> is to interactively view metabolism estimation data.

This program internally uses <span class="artifact-p">[anvi-estimate-metabolism](/help/9/programs/anvi-estimate-metabolism)</span> to obtain this data for the provided <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>.
