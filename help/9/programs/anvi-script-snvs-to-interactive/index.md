...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-snvs-to-interactive
image:
...
This programs takes a <span class="artifact-n">[variability-profile-txt](/help/9/artifacts/variability-profile-txt)</span> and generates the information necessary to visualize its contents with <span class="artifact-p">[anvi-interactive](/help/9/programs/anvi-interactive)</span>. 

Specifically, this program outputs a directory that contains a <span class="artifact-n">[profile-db](/help/9/artifacts/profile-db)</span>, a <span class="artifact-n">[view-data](/help/9/artifacts/view-data)</span> artifact, and a <span class="artifact-n">[dendrogram](/help/9/artifacts/dendrogram)</span>. For example, if you ran this program like so: 

<div class="codeblock" markdown="1">
anvi&#45;script&#45;snvs&#45;to&#45;interactive &#45;o OUTPUT_DIR \
                                <span class="artifact&#45;n">[variability&#45;profile](/help/9/artifacts/variability&#45;profile)</span>
</div>
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/snvs_to_interactive.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
