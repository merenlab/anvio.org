...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-checkm-tree-to-interactive
image:
...
A helper script to process CheckM tree output to generate files compatible with <span class="artifact-p">[anvi-interactive](/help/9/programs/anvi-interactive)</span>.
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/checkm_tree_to_interactive.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
