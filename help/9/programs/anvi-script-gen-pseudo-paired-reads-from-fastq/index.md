...
categories: [anvio]
comments: false
redirect_from: /9/anvi-script-gen-pseudo-paired-reads-from-fastq
image:
...
This program takes in a <span class="artifact-n">[short-reads-fasta](/help/9/artifacts/short-reads-fasta)</span> file and tries to recreate what paired reads for the data in that fasta file might look like. 
...
anvi&#45;script&#45;gen&#45;pseudo&#45;paired&#45;reads&#45;from&#45;fastq &#45;f <span class="artifact&#45;n">[short&#45;reads&#45;fasta](/help/9/artifacts/short&#45;reads&#45;fasta)</span> \
                                               &#45;O MY_READS 
</div>
...
{:.notice}
Are you aware of resources that may help users better understand the utility of this program? Please feel free to edit [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/gen_pseudo_paired_reads_from_fastq.py) on GitHub. If you are not sure how to do that, find the `__resources__` tag in [this file](https://github.com/merenlab/anvio/blob/master/anvio/cli/interactive.py) to see an example.
