...
This contains the taxonomy annotations for each of the single-copy core genes found in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>; in other words, this contains the results of a run of <span class="artifact-p">[anvi-run-scg-taxonomy](/help/9/programs/anvi-run-scg-taxonomy)</span>. 
...
This information allows you to quickly estimate the taxonomy of genomes, metagenomes, or bins stored in your contigs-db by using the command <span class="artifact-p">[anvi-estimate-scg-taxonomy](/help/9/programs/anvi-estimate-scg-taxonomy)</span>. 
