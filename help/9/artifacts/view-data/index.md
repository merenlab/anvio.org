...
You can use this to compute a distance matrix to generate a dendrogram (using <span class="artifact-p">[anvi-matrix-to-newick](/help/9/programs/anvi-matrix-to-newick)</span>) or direclty input it to <span class="artifact-p">[anvi-interactive](/help/9/programs/anvi-interactive)</span> to visualize the distribution of your items across samples. 
