...
categories: [anvio]
comments: false
redirect_from: /9/misc-data-amino-acids-txt
image:
...
This a tab-delimited text file that describes information contained in a <span class="artifact-n">[misc-data-amino-acids](/help/9/artifacts/misc-data-amino-acids)</span>. 
