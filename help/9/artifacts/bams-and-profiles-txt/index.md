...
categories: [anvio]
comments: false
redirect_from: /9/bams-and-profiles-txt
image:
...
A **TAB-delimited** file to describe anvi'o <span class="artifact-n">[single-profile-db](/help/9/artifacts/single-profile-db)</span> and <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> pairs along with the <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> used the profile the BAM file.
...
* `contigs_db_path`: path to a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>.
* `bam_file_path`: path to a <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span>.
* `profile_db_path`: path to a <span class="artifact-n">[single-profile-db](/help/9/artifacts/single-profile-db)</span> generated from the BAM file and the contigs database mentioned.
...
Some programs, such as <span class="artifact-p">[anvi-report-inversions](/help/9/programs/anvi-report-inversions)</span>, can process the `r1` and `r2` files.
