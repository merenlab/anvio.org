...
The number of columns and their content for files that are considered artifact <span class="artifact-n">[bam-stats-txt](/help/9/artifacts/bam-stats-txt)</span> will be variable and depend on the user parameters set for <span class="artifact-p">[anvi-profile-blitz](/help/9/programs/anvi-profile-blitz)</span>.

The column names may be one of these:

* `gene_callers_id`: Unique number assigned by the gene caller during the creation of the <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>.
* `contig`: Contig name as appears in the <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> and <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>
* `sample`: The name of the <span class="artifact-n">[bam-file](/help/9/artifacts/bam-file)</span> without its prefix. I.e., the value *SAMPLE-01* will appear in the *sample* column if the BAM file path was */path/to/SAMPLE-01.bam*.
...
Examples above generated by running <span class="artifact-p">[anvi-profile-blitz](/help/9/programs/anvi-profile-blitz)</span> in the mini-test output directory. To reproduce them, you can run this command to generate the necessary files,
...
and run <span class="artifact-p">[anvi-profile-blitz](/help/9/programs/anvi-profile-blitz)</span> in corresponding modes.
