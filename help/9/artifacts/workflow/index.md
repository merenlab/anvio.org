...
A set of output files generated by <span class="artifact-p">[anvi-run-workflow](/help/9/programs/anvi-run-workflow)</span> for a given anvi'o workflow. An anvi'o workflow is a set of instructions to be run via [Snakemake](https://snakemake.readthedocs.io/en/stable/).
