...
categories: [anvio]
comments: false
redirect_from: /9/misc-data-items-order-txt
image:
...
This is a text file that **contains the information for a <span class="artifact-n">[misc-data-items-order](/help/9/artifacts/misc-data-items-order)</span>**, used for importing into and exporting this information from your anvi'o project.
