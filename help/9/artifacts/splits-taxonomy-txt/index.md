...
categories: [anvio]
comments: false
redirect_from: /9/splits-taxonomy-txt
image:
...
This is the output of <span class="artifact-p">[anvi-export-splits-taxonomy](/help/9/programs/anvi-export-splits-taxonomy)</span>. It is in the same format as a <span class="artifact-n">[gene-taxonomy-txt](/help/9/artifacts/gene-taxonomy-txt)</span>, namely the first column identifies splits and the following columns describe the taxonomy hit associated with that split. 
