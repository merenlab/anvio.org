...
categories: [anvio]
comments: false
redirect_from: /9/functions-across-genomes-txt
image:
...
<p style="text-align: left" markdown="1"><span class="artifact-p">[anvi-script-gen-function-matrix-across-genomes](../../programs/anvi-script-gen-function-matrix-across-genomes)</span></p>
