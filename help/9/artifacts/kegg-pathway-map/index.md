...
categories: [anvio]
comments: false
redirect_from: /9/kegg-pathway-map
image:
...
Output PDF files produced by <span class="artifact-p">[anvi-draw-kegg-pathways](/help/9/programs/anvi-draw-kegg-pathways)</span> which show KEGG pathway map images. Files can consist of a single map or a grid of the same map with different information on each.
