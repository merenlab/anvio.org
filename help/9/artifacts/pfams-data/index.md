...
It is required to run <span class="artifact-p">[anvi-run-pfams](/help/9/programs/anvi-run-pfams)</span> and is set up on your computer by the program <span class="artifact-p">[anvi-setup-pfams](/help/9/programs/anvi-setup-pfams)</span>. 
