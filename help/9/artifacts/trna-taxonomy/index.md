...
This contains the taxonomic annotations for each of the tRNA sequences found in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>, which are the results of running <span class="artifact-p">[anvi-run-trna-taxonomy](/help/9/programs/anvi-run-trna-taxonomy)</span>. 

You can use this information to estimate the taxnomy of genomes, metagenomes, or collections stored in your <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> using the program <span class="artifact-p">[anvi-estimate-trna-taxonomy](/help/9/programs/anvi-estimate-trna-taxonomy)</span>
