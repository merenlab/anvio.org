...
categories: [anvio]
comments: false
redirect_from: /9/short-reads-fasta
image:
...
A <span class="artifact-n">[fasta](/help/9/artifacts/fasta)</span> file that contains often unassembled, short metagenomic reads.
