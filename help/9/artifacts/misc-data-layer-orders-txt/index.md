...
categories: [anvio]
comments: false
redirect_from: /9/misc-data-layer-orders-txt
image:
...
This a tab-delimited text file that describes information contained in a <span class="artifact-n">[misc-data-layer-orders](/help/9/artifacts/misc-data-layer-orders)</span>. 
