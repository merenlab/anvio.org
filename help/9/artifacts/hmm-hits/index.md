...
The search results for an <span class="artifact-n">[hmm-source](/help/9/artifacts/hmm-source)</span> in a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>. Essentially, this is the part of a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> that handles the HMM data. In anvi'o, this is usually functional annotations, such as identifying specific ribosomal RNAs, various single-copy core genes, and transfer RNAs, though the user can also define their own HMM sources. 

Upon creation, a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> will not contain any HMM results. In order to populate it, users can run <span class="artifact-p">[anvi-run-hmms](/help/9/programs/anvi-run-hmms)</span> using any <span class="artifact-n">[hmm-source](/help/9/artifacts/hmm-source)</span>. The program <span class="artifact-p">[anvi-scan-trnas](/help/9/programs/anvi-scan-trnas)</span> also populates a <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>'s hmm-hits with potential transfer RNA hits.
