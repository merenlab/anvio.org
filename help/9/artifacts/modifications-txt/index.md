...
categories: [anvio]
comments: false
redirect_from: /9/modifications-txt
image:
...
The modifications shown in this table are from the seeds represented in the <span class="artifact-n">[seeds-specific-txt](/help/9/artifacts/seeds-specific-txt)</span> and <span class="artifact-n">[seeds-non-specific-txt](/help/9/artifacts/seeds-non-specific-txt)</span> example tables.
