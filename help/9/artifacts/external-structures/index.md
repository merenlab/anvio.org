...
categories: [anvio]
comments: false
redirect_from: /9/external-structures
image:
...
By default, anvi'o predicts protein structures using MODELLER when creating a <span class="artifact-n">[structure-db](/help/9/artifacts/structure-db)</span>. Yet, if the user provides an external structures file, then anvi'o does not perform template-based homology modelling, and instead uses this file to obtain the structure information for the <span class="artifact-n">[structure-db](/help/9/artifacts/structure-db)</span>.
...
Each path should point to a <span class="artifact-n">[protein-structure-txt](/help/9/artifacts/protein-structure-txt)</span>.
