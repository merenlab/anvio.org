...
This is a text file containing **the average coverage for each contig in each sample** that was in the <span class="artifact-n">[profile-db](/help/9/artifacts/profile-db)</span> and <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span> that you used when you ran <span class="artifact-p">[anvi-export-splits-and-coverages](/help/9/programs/anvi-export-splits-and-coverages)</span> or <span class="artifact-p">[anvi-export-gene-coverage-and-detection](/help/9/programs/anvi-export-gene-coverage-and-detection)</span>. 
...
(the type of output you would get from <span class="artifact-p">[anvi-export-splits-and-coverages](/help/9/programs/anvi-export-splits-and-coverages)</span>)
...
(the type of output you would get from <span class="artifact-p">[anvi-export-gene-coverage-and-detection](/help/9/programs/anvi-export-gene-coverage-and-detection)</span>)
