...
In anvi'o, this is used by <span class="artifact-p">[anvi-script-process-genbank](/help/9/programs/anvi-script-process-genbank)</span> to convert the information in the genbank file to a <span class="artifact-n">[contigs-fasta](/help/9/artifacts/contigs-fasta)</span>, <span class="artifact-n">[external-gene-calls](/help/9/artifacts/external-gene-calls)</span>, and <span class="artifact-n">[functions-txt](/help/9/artifacts/functions-txt)</span>. 
