...
Such files are typically generated by the program `hmmbuild` (which is a part of the [HMMER](http://hmmer.org/) package and installed in every anvi'o environment) from FASTA files of gene amino acid sequence alignments. A properly formatted <span class="artifact-n">[hmm-file](/help/9/artifacts/hmm-file)</span> will look more or less like this:
