...
categories: [anvio]
comments: false
redirect_from: /9/protein-structure-txt
image:
...
This is a Protein Data Bank (`X.pdb`) file that describes the structure of a protein as stored in your <span class="artifact-n">[structure-db](/help/9/artifacts/structure-db)</span>. This is the output of running <span class="artifact-p">[anvi-export-structures](/help/9/programs/anvi-export-structures)</span>.
