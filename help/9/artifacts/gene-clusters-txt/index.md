...
categories: [anvio]
comments: false
redirect_from: /9/gene-clusters-txt
image:
...
The primary purpose of this file is to provide a means for the user to let the anvi'o know about their gene clusters, rather than computing gene clusters through the conventional pangenomics approach implemented in anvi'o and accessible via <span class="artifact-p">[anvi-pan-genome](/help/9/programs/anvi-pan-genome)</span>.

For instance, through this file the user can ask <span class="artifact-p">[anvi-pan-genome](/help/9/programs/anvi-pan-genome)</span> to make use of the gene clusters they have identified in their genomes using another program, and still use downstream anvi'o programs, such as <span class="artifact-p">[anvi-display-pan](/help/9/programs/anvi-display-pan)</span> or <span class="artifact-p">[anvi-compute-functional-enrichment-in-pan](/help/9/programs/anvi-compute-functional-enrichment-in-pan)</span> to work with the resulting <span class="artifact-n">[pan-db](/help/9/artifacts/pan-db)</span>.

## File format

A proper <span class="artifact-n">[gene-clusters-txt](/help/9/artifacts/gene-clusters-txt)</span> file must contain the following headers,
...
* **genome_name** represents a genome name that matches to a genome that is in the <span class="artifact-n">[genomes-storage-db](/help/9/artifacts/genomes-storage-db)</span>,
...
Please note that It is possible to obtain this file for an already computed anvi'o <span class="artifact-n">[pan-db](/help/9/artifacts/pan-db)</span> using the program <span class="artifact-p">[anvi-export-gene-clusters](/help/9/programs/anvi-export-gene-clusters)</span>.
