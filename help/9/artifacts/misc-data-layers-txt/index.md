...
categories: [anvio]
comments: false
redirect_from: /9/misc-data-layers-txt
image:
...
This a tab-delimited text file that describes information contained in a <span class="artifact-n">[misc-data-layers](/help/9/artifacts/misc-data-layers)</span>. 
