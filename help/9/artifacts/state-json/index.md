...
This is a JSON file that describes a <span class="artifact-n">[state](/help/9/artifacts/state)</span>. It is the output of <span class="artifact-p">[anvi-export-state](/help/9/programs/anvi-export-state)</span> and can be imported into the interface (through a database) using <span class="artifact-p">[anvi-export-state](/help/9/programs/anvi-export-state)</span>. 
