...
It is required to run <span class="artifact-p">[anvi-run-ncbi-cogs](/help/9/programs/anvi-run-ncbi-cogs)</span> and is set up on your computer by the program <span class="artifact-p">[anvi-setup-ncbi-cogs](/help/9/programs/anvi-setup-ncbi-cogs)</span>. 
...
Please see the help page for <span class="artifact-p">[anvi-setup-ncbi-cogs](/help/9/programs/anvi-setup-ncbi-cogs)</span> if you want to learn how to choose which version to set up on your computer.
