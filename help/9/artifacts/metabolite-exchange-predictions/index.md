...
categories: [anvio]
comments: false
redirect_from: /9/metabolite-exchange-predictions
image:
...
This page describes the output files produced by the program <span class="artifact-p">[anvi-predict-metabolic-exchanges](/help/9/programs/anvi-predict-metabolic-exchanges)</span>. Breifly, the most important outputs of this program are:
...
All of the examples shown here were generated by running <span class="artifact-p">[anvi-predict-metabolic-exchanges](/help/9/programs/anvi-predict-metabolic-exchanges)</span> on the genomes of _Baumannia cicadellinicola_ and _Sulcia muelleri_, which are known to exchange amino acids and vitamins as part of their co-symbiosis within the glassy-winged sharpshooter ([Wu et al, 2006](https://doi.org/10.1371/journal.pbio.0040188)).
...
- `genomes`: which genomes are involved in the potential exchange (labeled by the name set in the <span class="artifact-n">[contigs-db](/help/9/artifacts/contigs-db)</span>)
