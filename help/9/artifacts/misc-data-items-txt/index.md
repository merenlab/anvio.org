...
categories: [anvio]
comments: false
redirect_from: /9/misc-data-items-txt
image:
...
This a tab-delimited text file that describes information contained in a <span class="artifact-n">[misc-data-items](/help/9/artifacts/misc-data-items)</span>. 
