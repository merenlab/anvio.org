...
{:.notice}
The help contents were last updated on **04 Nov 23 12:35:33** for anvi'o version **8-dev (marie)**.
...
Listed below **a total of 133 artifacts**.
...
<tr>
    <td class="artifact-p-td">
    <span class="artifact-emoji">🍕</span>
        <span class="artifact-p" markdown="1">[contigs-fasta](artifacts/contigs-fasta) <img src="images/icons/FASTA.png" class="artifact-icon-mini" /></span> <span class="artifact-p" markdown="1">[rename-report-file](artifacts/rename-report-file) <img src="images/icons/TXT.png" class="artifact-icon-mini" /> </span>
    </td>
</tr>
<tr style="border:none;">
    <td class="program-td">
