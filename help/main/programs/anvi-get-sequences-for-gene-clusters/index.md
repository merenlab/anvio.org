...
This aptly-named program **gets the sequences for the gene clusters stored in a <span class="artifact-n">[pan-db](/software/anvio/help/main/artifacts/pan-db)</span> and returns them as either a <span class="artifact-n">[genes-fasta](/software/anvio/help/main/artifacts/genes-fasta)</span> or a <span class="artifact-n">[concatenated-gene-alignment-fasta](/software/anvio/help/main/artifacts/concatenated-gene-alignment-fasta)</span>** (which you can use to run <span class="artifact-p">[anvi-gen-phylogenomic-tree](/software/anvio/help/main/programs/anvi-gen-phylogenomic-tree)</span>). This gives you advanced access to your gene clusters, which you can take out of anvi'o, use for phylogenomic analyses, or do whatever you please with. 
...
To get a <span class="artifact-n">[concatenated-gene-alignment-fasta](/software/anvio/help/main/artifacts/concatenated-gene-alignment-fasta)</span> (which you can use to run <span class="artifact-p">[anvi-gen-phylogenomic-tree](/software/anvio/help/main/programs/anvi-gen-phylogenomic-tree)</span>), use the parameter `--concatenate-gene-clusters`
