...
- parse the flat text file for each KEGG module and store the information into the <span class="artifact-n">[modules-db](/help/main/artifacts/modules-db)</span>
