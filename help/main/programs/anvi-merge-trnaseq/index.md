...
Most of the heavy computational work in the [trnaseq-workflow](../../workflows/trnaseq/) is performed by <span class="artifact-p">[anvi-trnaseq](/help/main/programs/anvi-trnaseq)</span>. anvi-merge-trnaseq is meant to run relatively quickly, allowing its parameters to be tuned to fit the dataset.
