...
The simplest approach is the one shown [in the Infant Gut Tutorial](https://merenlab.org/tutorials/infant-gut/#measuring-distances-between-metagenomes-with-fst): provide a <span class="artifact-n">[variability-profile](/help/main/artifacts/variability-profile)</span>, as follows: 
...
This will use the information in your <span class="artifact-n">[variability-profile-txt](/help/main/artifacts/variability-profile-txt)</span> to generate the fixation index for each pairwise sample comparison and store the results in a <span class="artifact-n">[fixation-index-matrix](/help/main/artifacts/fixation-index-matrix)</span> named `my_matrix.txt`.  

### Input 2: Anvi'o databases

Instead of providing a <span class="artifact-n">[variability-profile](/help/main/artifacts/variability-profile)</span>, you can provide the inputs to <span class="artifact-p">[anvi-gen-variability-profile](/help/main/programs/anvi-gen-variability-profile)</span> and allow anvi'o to perform all the work for you. Specifically, this means providing a <span class="artifact-n">[contigs-db](/help/main/artifacts/contigs-db)</span> and <span class="artifact-n">[profile-db](/help/main/artifacts/profile-db)</span> pair to identify your variability positions and a specific subset to focus on in any of these ways: 
...
Additionally, you can add structural annotations by providing a <span class="artifact-n">[structure-db](/help/main/artifacts/structure-db)</span> (and focus only on genes with structural annotations using the flag `--only-if-structure`) or choose to focus on only a subset of your samples by providing a file of samples of interest.  
