...
This tab-delimited file can be easily manipulated by the user. It is required input for <span class="artifact-p">[anvi-plot-trnaseq](/software/anvio/help/main/programs/anvi-plot-trnaseq)</span>.
