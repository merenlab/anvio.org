...
Items additional data is organized into **data groups**. Each group is a named collection of related data keys. For example, when you run <span class="artifact-p">[anvi-pan-genome](/help/main/programs/anvi-pan-genome)</span>, anvi'o automatically creates several groups:
...
When you import your own data with <span class="artifact-p">[anvi-import-misc-data](/help/main/programs/anvi-import-misc-data)</span> without specifying a group (via the `-D` flag), it goes into the `default` group.
