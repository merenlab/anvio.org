...
You can convert the information in a <span class="artifact-n">[variability-profile-txt](/software/anvio/help/main/artifacts/variability-profile-txt)</span> to <span class="artifact-n">[vcf](/software/anvio/help/main/artifacts/vcf)</span> with the program <span class="artifact-p">[anvi-script-variability-to-vcf](/software/anvio/help/main/programs/anvi-script-variability-to-vcf)</span>. 
