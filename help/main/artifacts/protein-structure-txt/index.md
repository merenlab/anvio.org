...
This is a Protein Data Bank (`X.pdb`) file that describes the structure of a protein as stored in your <span class="artifact-n">[structure-db](/help/main/artifacts/structure-db)</span>. This is the output of running <span class="artifact-p">[anvi-export-structures](/help/main/programs/anvi-export-structures)</span>.
