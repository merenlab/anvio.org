...
This means that a matrix with more columns will inherently have more influence on the final clustering. Understanding this is important when designing your configurations. You can use the `--export-merged-matrix` flag of <span class="artifact-p">[anvi-experimental-organization](/help/main/programs/anvi-experimental-organization)</span> to inspect the final merged matrix that goes into clustering.


{:.notice}
Edit [this file](https://github.com/merenlab/anvio/tree/master/anvio/docs/artifacts/clustering-configuration.md) to update this information.
