...
From the interface, the bottom section of the left panel enables you to save and load states. You also have the option to import states with <span class="artifact-p">[anvi-import-state](/software/anvio/help/main/programs/anvi-import-state)</span> or export them with <span class="artifact-p">[anvi-export-state](/software/anvio/help/main/programs/anvi-export-state)</span>. You can also delete states you no longer need anymore with <span class="artifact-p">[anvi-delete-state](/software/anvio/help/main/programs/anvi-delete-state)</span>. 
