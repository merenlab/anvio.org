...
The number of columns and their content will be variable and depend on the user parameters set for <span class="artifact-p">[anvi-profile-blitz](/help/main/programs/anvi-profile-blitz)</span>.
...
* `contig`: Contig name as appears in the <span class="artifact-n">[bam-file](/help/main/artifacts/bam-file)</span> and <span class="artifact-n">[contigs-db](/help/main/artifacts/contigs-db)</span> (for contig-level stats)
* `bin`: Genome name as it appears in the <span class="artifact-n">[collection](/help/main/artifacts/collection)</span> being worked on (for genome-level stats)
* `gene_callers_id`: Gene ID number as it appears in the <span class="artifact-n">[contigs-db](/help/main/artifacts/contigs-db)</span> (for gene-level stats)
...
These files can also contain Distribution of Coverage (DisCov) scores and related data values. You can see a fuller description of these in <span class="artifact-n">[discov-stats](/help/main/artifacts/discov-stats)</span>, but here is a quick overview of the related columns:
