...
Examples above generated by running <span class="artifact-p">[anvi-profile-blitz](/software/anvio/help/main/programs/anvi-profile-blitz)</span> in the mini-test output directory. To reproduce them, you can run this command to generate the necessary files,
...
and run <span class="artifact-p">[anvi-profile-blitz](/software/anvio/help/main/programs/anvi-profile-blitz)</span> in coresponding modes.
