...
There are two types of variability the program <span class="artifact-p">[anvi-profile](/help/main/programs/anvi-profile)</span> can characterize and store: substitutions and indels.
...
You can learn the name of the table in which anvi'o stores this in a given <span class="artifact-n">[profile-db](/help/main/artifacts/profile-db)</span> by running this command in your anvi'o environment:
