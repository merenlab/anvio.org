...
categories: [anvio]
comments: false
redirect_from: /m/contig-circularity-report-txt
image:
...
A report produced by <span class="artifact-p">[anvi-report-circularity](/help/main/programs/anvi-report-circularity)</span> will have 12 TAB-delimited columns. Here is a snippet from an example output file:
...
* `contig`: name of the reference sequence in the <span class="artifact-n">[bam-file](/help/main/artifacts/bam-file)</span>.
