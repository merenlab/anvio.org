...
This a tab-delimited text file that describes information contained in a <span class="artifact-n">[misc-data-items](/help/main/artifacts/misc-data-items)</span>. 
