...
categories: [anvio]
comments: false
redirect_from: /m/sra-metadata-txt
image:
...
<p style="text-align: left" markdown="1"><span class="artifact-p">[anvi-script-get-sra-metadata](../../programs/anvi-script-get-sra-metadata)</span></p>
...
Anvi'o will build this file on its own when a workflow first needs it. If the machine that runs your workflows has no internet access, or you would simply like to see what anvi'o thinks before it acts on it, you can build it in advance with <span class="artifact-p">[anvi-script-get-sra-metadata](/help/main/programs/anvi-script-get-sra-metadata)</span>.


{:.notice}
Edit [this file](https://github.com/merenlab/anvio/tree/master/anvio/docs/artifacts/sra-metadata-txt.md) to update this information.
