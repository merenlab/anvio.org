---
layout: blog
title: "An anvi'o tutorial with Trichodesmium genomes (Chapter XXX)"
modified: 2024-03-18
excerpt: "The XXX Chapter"
categories: [anvio]
authors: [ivagljiva, FlorianTrigodet]
tags: [XXX, hands-on, beginner]
comments: true
---

{:.warning}
This page is not meant to be public, but to serve as a convenient template from which to add more chapters to this tutorial. Please update the 'XXX' values wherever you see them, add in your chapter-specific content, update the Navigation sections of all other tutorial pages, and don't forget to remove this warning box before publishing :)
...
- [Chapter XXX: XXX]({{ site.url }}/tutorials/trichodesmium-tutorial/chapter-XXX) ← _you are here_
...
XXX Everything you want to include in this chapter of the tutorial should replace this text in this section. XXX

## The next chapter

If you want to immediately move on to the next chapter of this tutorial, here is the link:

- [XXX]({{ site.url }}/tutorials/trichodesmium-tutorial/)
