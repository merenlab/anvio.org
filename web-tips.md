...
inoreabbrev bams-and-profiles-txti {% include ARTIFACT name="bams-and-profiles-txt" %}
inoreabbrev markdown-txti {% include ARTIFACT name="markdown-txt" %}
...
inoreabbrev enzymes-txti {% include ARTIFACT name="enzymes-txt" %}
...
inoreabbrev user-modules-datai {% include ARTIFACT name="user-modules-data" %}
...
inoreabbrev inversions-txti {% include ARTIFACT name="inversions-txt" %}
...
inoreabbrev functions-across-genomes-txti {% include ARTIFACT name="functions-across-genomes-txt" %}
inoreabbrev hmm-hits-across-genomes-txti {% include ARTIFACT name="hmm-hits-across-genomes-txt" %}
...
inoreabbrev user-metabolismi {% include ARTIFACT name="user-metabolism" %}
...
inoreabbrev anvi-search-primersi {% include PROGRAM name="anvi-search-primers" %}
...
inoreabbrev anvi-setup-user-modulesi {% include PROGRAM name="anvi-setup-user-modules" %}
...
inoreabbrev anvi-script-gen-function-matrix-across-genomesi {% include PROGRAM name="anvi-script-gen-function-matrix-across-genomes" %}
